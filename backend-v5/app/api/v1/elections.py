...
from app.services.wikileaks_service import get_wikileaks_service
from app.services.leadership_profile_service import (
    generate_leadership_profile,
    profile_to_dict,
    clear_profile_cache,
)
...
async def get_candidate_wikileaks(
    ...
    **Use cases:**
    ...
    # Search WikiLeaks
    wikileaks_service = await get_wikileaks_service()
    result = await wikileaks_service.search(
        candidate_name=candidate.name_en,
